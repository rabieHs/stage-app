...
class satgesvalides extends StatefulWidget {
  const satgesvalides({super.key});

  @override
  State<satgesvalides> createState() => _satgesvalidesState();
}

class _satgesvalidesState extends State<satgesvalides> {
  Uint8List? fileBytes;
                              ...
                              return AlertDialog(
                                ...
                                content: InkWell(
                                  onTap: () async {
                                    ...
                                    if (resultat != null) {
                                      setState(() {
                                        fileBytes = resultat.files.first.bytes!;
                                      });
